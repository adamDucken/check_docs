...
- External re-export candidates are checked with the selected compiler against
  the exact compiled dependency artifact before reporting success. This detects
